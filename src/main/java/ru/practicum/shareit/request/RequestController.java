...
public class RequestController {
    ...
    @PostMapping
    public RequestDto add(@RequestHeader("X-Sharer-User-Id") Long userId, @Valid @RequestBody RequestDto requestDto) {
    ...
    public RequestDto getOne(@RequestHeader("X-Sharer-User-Id") Long userId, @PathVariable Long requestId) {
